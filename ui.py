...
class UI:
    ...
    @staticmethod
    def get_quick_reply():
        """Quick reply with maximum 13 items (LINE API limit)"""
        items = [
            ("بداية", "بداية"),
            ("العاب", "العاب"),
            ("نصوص", "نص"),
    ...
    def welcome(name, registered, theme="light"):
        """Welcome screen with registration status"""
        c = UI._c(theme)
    ...
    def games_menu(theme="light"):
        """Games menu with all available games"""
        c = UI._c(theme)
