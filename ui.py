...
class UI:
    ...
    def welcome(name, registered, theme="light"):
        ...
        if not registered:
            contents.append({
                ...
                "contents": [
                    ...
                    {"type": "text", "text": "يمكنك استخدام البوت في الخاص و القروب",
        ...
        contents.extend([
            ...
            {"type": "text", "text": "تم انشاء هذا البوت بواسطة عبير الدوسري - 2025",
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "separator", "margin": "md", "color": c["border"]},
                    {
                        "type": "box", "layout": "vertical",
                        "contents": [
                            {"type": "text", "text": "الاوامر الاساسية", "size": "sm",
                             "weight": "bold", "color": c["text"], "margin": "md"},
                            {"type": "text", "text": "بداية - العودة للقائمة الرئيسية\nتسجيل - تسجيل اسمك في البوت\nنقاطي - عرض نقاطك واحصائياتك\nالصدارة - عرض قائمة المتصدرين",
                    ...
                    },
                    {
                        "type": "box", "layout": "vertical",
                        "contents": [
                            {"type": "text", "text": "الالعاب", "size": "sm",
                             "weight": "bold", "color": c["text"], "margin": "md"},
                            {"type": "text", "text": "العاب - قائمة جميع الالعاب\nاكتب اسم اللعبة لبدء اللعب\nلمح - للحصول على مساعدة\nجاوب - لعرض الاجابة\nايقاف - لايقاف اللعبة",
                             "size": "xs", "color": c["text2"], "wrap": True, "margin": "xs"}
                        ]
                    },
                    {
                        "type": "box", "layout": "vertical",
                        "contents": [
                            {"type": "text", "text": "النصوص", "size": "sm",
                             "weight": "bold", "color": c["text"], "margin": "md"},
                            {"type": "text", "text": "سؤال - اسئلة عميقة\nمنشن - منشن عشوائي\nتحدي - تحديات ممتعة\nاعتراف - اعترافات\nمجهول - رسائل مجهولة\nخاص - اسئلة خاصة\nاقتباس - اقتباسات ملهمة\nموقف - مواقف افتراضية\nنصيحة - نصائح حياتية\nشعر - ابيات شعرية",
                             "size": "xs", "color": c["text2"], "wrap": True, "margin": "xs"}
                        ]
                    },
                    {
                        "type": "box", "layout": "vertical",
                        "contents": [
                            {"type": "text", "text": "ملاحظات", "size": "sm",
                             "weight": "bold", "color": c["text"], "margin": "md"},
                            {"type": "text", "text": "يجب التسجيل اولا للعب الالعاب\nاستخدم انسحب للخروج من اي لعبة\nيمكنك تغيير الثيم بين الفاتح والداكن\nالنقاط تحفظ تلقائيا بعد كل لعبة",
                             "size": "xs", "color": c["text2"], "wrap": True, "margin": "xs"}
                        ]
                    },
                    {"type": "separator", "margin": "lg", "color": c["border"]},
    ...
    def text_menu(theme="light"):
        ...
        texts = ["سؤال", "منشن", "تحدي", "اعتراف", "مجهول", "خاص",
                 "اقتباس", "موقف", "نصيحة", "شعر"]
        ...
        for i in range(0, len(texts), 3):
            contents.append({
                ...
                "contents": [UI._button(t, t, c) for t in texts[i:i + 3]]
            })
    ...
    def games_menu(theme="light"):
        ...
        for i in range(0, len(games), 3):
            contents.append({
                "type": "box", "layout": "horizontal", "spacing": "xs", "margin": "sm",
                "contents": [UI._button(label, cmd, c) for label, cmd in games[i:i + 3]]
            })
                    ...
                    {"type": "separator", "margin": "md", "color": c["border"]},
                    {
                        ...
                        "contents": [
                            ...
                            {"type": "text", "text": f"{user['points']} نقطة", "size": "xxl",
                             "weight": "bold", "color": c["primary"], "align": "center", "margin": "sm"}
                        ],
                        ...
                        "contents": [
                            {
                                ...
                                "contents": [
                                    {"type": "text", "text": "عدد الالعاب", "size": "xs",
                            ...
                            },
                            {
                                ...
                                "contents": [
                                    ...
                                    {"type": "text", "text": f"{win_rate}%", "size": "xl",
                                     "weight": "bold", "color": c["primary"], "align": "center", "margin": "xs"}
                                ]
                            }
                        ],
                        "margin": "md"
    ...
    def leaderboard(leaders, theme="light"):
        ...
        if not leaders:
            contents.append({
                "type": "text", "text": "لا يوجد لاعبون بعد", "size": "sm",
