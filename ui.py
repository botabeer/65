...
class UI:
    ...
    def get_quick_reply():
        items = [
            ...
            ("نقاطي", "نقاطي"), ("صدارة", "الصدارة"), ("ثيم", "ثيم"), ("مساعدة", "مساعدة")
        ]
    ...
    def welcome(name, registered, theme="light"):
        ...
        contents.extend([
            {"type": "separator", "margin": "lg", "color": c["border"]},
            {"type": "text", "text": "بوت 65 - 2025", "size": "xxs", "color": c["text3"], "align": "center", "margin": "md"}
        ])
        
        return {
            "type": "bubble", "size": "mega",
            "body": {
                "type": "box", "layout": "vertical", "backgroundColor": c["bg"],
                "paddingAll": "20px", "contents": contents
            }
        }
    ...
    def help_card(theme="light"):
        ...
        sections = [
            ...
            {"title": "اوامر النصوص", "items": ["سؤال - اسئلة متنوعة", "تحدي - تحديات", "اعتراف - اعترافات", "منشن - منشن اصدقائك", "اقتباس - اقتباسات ملهمة", "نصيحة - نصائح يومية"]},
        ...
        contents.extend([
            {"type": "separator", "margin": "lg", "color": c["border"]},
            {"type": "box", "layout": "horizontal", "margin": "md", "contents": [UI._button("رجوع", "بداية", c)]}
        ])
    ...
    def text_menu(theme="light"):
        ...
        contents = [
            ...
            {"type": "text", "text": "اختر نوع النص المطلوب", "size": "xs", "color": c["text2"], "align": "center", "margin": "xs"},
            {"type": "separator", "margin": "md", "color": c["border"]}
        ]
            ...
            "body": {
                ...
                "contents": [
                    ...
                    {"type": "box", "layout": "horizontal", "margin": "md", "spacing": "xs",
                     "contents": [UI._button("صدارة", "الصدارة", c), UI._button("رجوع", "بداية", c)]}
                ]
            }
        }
