...
class UI:
    ...
    def welcome(name, registered, theme="light"):
        ...
        contents.extend([
            ...
            {
                "type": "text",
                "text": "تم انشاء هذا البوت بواسطة عبير الدوسري - 2025",
                "size": "xxs",
                "color": c["text3"],
                "align": "center"
            }
    ...
    def games_menu(theme="light"):
        ...
        contents.extend([
            ...
            {
                "type": "text",
                "text": "اكتب صعوبة 1 الى 5 لتغيير مستوى الصعوبة",
                "size": "xxs",
                "color": c["text3"],
                "align": "center",
                "margin": "xs"
