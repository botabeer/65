...
class UI:
    ...
    def welcome(name, registered, theme="light"):
        ...
        contents = [
            ...
            {"type": "text", "text": f"مرحبا {name}", "size": "md", "align": "center", "color": c["text2"], "margin": "sm"},
        ...
        if not registered:
            contents.append({
                ...
                "borderColor": c["error"],
                "contents": [
                    {"type": "text", "text": "يجب التسجيل للعب", "size": "sm", "weight": "bold", "align": "center", "color": c["error"]},
    ...
    def text_commands_menu(theme="light"):
        ...
        contents = [
            ...
            {"type": "text", "text": "اختر نوع المحتوى", "size": "xs", "color": c["text2"], "align": "center", "margin": "xs"},
        ...
        contents.append({"type": "box", "layout": "horizontal", "margin": "md", "contents": [UI._btn("رجوع", "بداية", theme)]})
        return {"type": "bubble", "size": "mega", "body": {"type": "box", "layout": "vertical", "backgroundColor": c["bg"], "paddingAll": "20px", "contents": contents}}
    ...
    def help_card(theme="light"):
        ...
        sections = [
            ...
            {"title": "اوامر النصوص", "items": ["نص - قائمة النصوص", "سؤال - اسئلة متنوعة", "تحدي - تحديات ممتعة", "منشن - منشن اصدقائك", "اقتباس - اقتباسات ملهمة"]},
            {"title": "اوامر اللعب", "items": ["لمح - تلميح للاجابة", "جاوب - اظهار الجواب", "ايقاف - ايقاف اللعبة"]},
            {"title": "ملاحظات مهمة", "items": ["يجب التسجيل قبل اللعب", "النقاط تحفظ تلقائيا", "الالعاب متعددة اللاعبين"]}
        ]
        contents = [
    ...
    def stats(user, theme="light"):
        ...
        contents = [
            ...
            {"type": "separator", "margin": "md", "color": c["border"]},
            {"type": "box", "layout": "vertical", "margin": "lg", "backgroundColor": c["card"], "cornerRadius": "12px", "paddingAll": "16px", "contents": [
            ...
            {"type": "separator", "margin": "lg", "color": c["border"]},
            {"type": "box", "layout": "horizontal", "margin": "md", "spacing": "sm", "contents": [UI._btn("الصدارة", "الصدارة", theme), UI._btn("رجوع", "بداية", theme)]}
        ]
        return {"type": "bubble", "size": "mega", "body": {"type": "box", "layout": "vertical", "backgroundColor": c["bg"], "paddingAll": "20px", "contents": contents}}
