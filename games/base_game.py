...
class BaseGame(ABC):
    THEMES = {
        "light": {
            ...
            "button": "#F1F5F9", "success": "#0EA5E9", "accent": "#3B82F6"
        },
        "dark": {
            "primary": "#F1F5F9", "text": "#CBD5E1", "text2": "#94A3B8",
            "bg": "#0F172A", "card": "#1E293B", "border": "#334155",
            "button": "#334155", "success": "#38BDF8", "accent": "#60A5FA"
        }
    }
            ...
            {"type": "box", "layout": "vertical", "margin": "md",
             "contents": [
                 {"type": "text", "text": f"السؤال {self.current_question + 1} من {self.questions_count}",
                  "size": "xs", "color": c["text2"], "align": "center"},
    ...
    def end_game(self):
        ...
        contents = [
            ...
            {"type": "box", "layout": "vertical", "margin": "lg",
             "contents": [
                 {"type": "text", "text": winner['name'], "size": "lg",
        ...
        if len(sorted_players) > 1:
            contents.append(
                {"type": "text", "text": "النتائج", "size": "sm",
                ...
                contents.append({
                    ...
                    "contents": [
                        {"type": "text", "text": f"{i+1}", "size": "sm",
                         "color": c["text2"], "flex": 0},
                        {"type": "text", "text": data['name'], "size": "sm",
                         "color": c["text"], "flex": 3, "margin": "sm"},
                        {"type": "text", "text": str(data['score']), "size": "sm",
