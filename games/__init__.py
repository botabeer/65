...
__all__ = [
    'BaseGame', 'GuessGame', 'FastGame', 'CompatibilityGame',
    'SongGame', 'OppositeGame', 'ChainGame', 'LettersGame',
    'CategoryGame', 'HumanAnimalGame', 'IqGame', 'ScrambleGame',
    'LetterGame', 'MafiaGame'
]
